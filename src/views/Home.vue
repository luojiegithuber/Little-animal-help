      ...
      <van-grid :border="false" :column-num="3" v-show="!skeletonShow">
        <van-grid-item>
          <div @click="$router.push('/another')">
            <grid-content iconStr="percy-icon-meishi2" msg="标记地点"></grid-content>
          </div>
        </van-grid-item>
        <van-grid-item>
          <div @click="$router.push('/another')">
            <grid-content iconStr="percy-icon-dianying" msg="请求援助" number="43"></grid-content>
          </div>
        </van-grid-item>
        <van-grid-item>
          <div @click="$router.push('/another')">
            <grid-content iconStr="percy-icon-yule" msg=""></grid-content>
          </div>
        </van-grid-item>
        <van-grid-item>
          <div @click="$router.push('/another')">
